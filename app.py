...
firebase_admin.initialize_app(cred, {
    'databaseURL': 'https://company-website-b6be1-default-rtdb.firebaseio.com/'
})
...
def index():
    ...
    social_ref = db.reference('social')
    social = social_ref.get()
    ...
    return render_template('index.html',about=about,services = services, applications = applications,skills=skills, reviews = reviews,social=social)
